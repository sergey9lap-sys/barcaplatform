...
cross join (values
  ...
  ('Жоау Канселу', 2, 'DF'), ('Хави Эспарт', 36, 'DF'), ('Альваро Кортес', 26, 'DF'),
  ('Жорди Пескер', 33, 'DF'), ('Гави', 6, 'MF'), ('Педри', 8, 'MF'),
  ('Фермин Лопес', 7, 'MF'), ('Дани Ольмо', 20, 'MF'), ('Френки де Йонг', 21, 'MF'),
  ('Марк Берналь', 22, 'MF'), ('Родри', 16, 'MF'), ('Эбрима Тункара', null, 'MF'),
  ('Ориан Горен', null, 'MF'), ('Брайан Фариньяс', 28, 'MF'), ('Ламин Ямаль', 10, 'FW'),
  ('Рафинья', 11, 'FW'), ('Энтони Гордон', 17, 'FW'), ('Карим Адейеми', 14, 'FW'),
  ('Джесси Бисиву', 27, 'FW'), ('Алекс Гонсалес', null, 'FW'), ('Хамза Абделькарим', 29, 'FW')
