...
const currentSquad = [
  ...
  { player_id: "player-xavi-espart", player_name: "Хави Эспарт", player_number: 36, position: "DF" },
  { player_id: "player-alvaro-cortes", player_name: "Альваро Кортес", player_number: 26, position: "DF" },
  { player_id: "player-jordi-pesquer", player_name: "Жорди Пескер", player_number: 33, position: "DF" },
  ...
  { player_id: "player-brian-farinas", player_name: "Брайан Фариньяс", player_number: 28, position: "MF" },
