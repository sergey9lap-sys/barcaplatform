...
const currentSquad = [
  ...
  { player_id: "player-fermin-lopez", player_name: "Фермин Лопес", player_number: 7, position: "MF" },
  ...
  { player_id: "player-rodri", player_name: "Родри", player_number: 16, position: "MF" },
  ...
  { player_id: "player-anthony-gordon", player_name: "Энтони Гордон", player_number: 17, position: "FW" },
  { player_id: "player-karim-adeyemi", player_name: "Карим Адейеми", player_number: 14, position: "FW" },
  { player_id: "player-jesse-bisiwu", player_name: "Джесси Бисиву", player_number: 27, position: "FW" },
  { player_id: "player-xavi-espart", player_name: "Хави Эспарт", player_number: 28, position: "DF" },
  { player_id: "player-alvaro-cortes", player_name: "Альваро Кортес", player_number: null, position: "DF" },
  { player_id: "player-jordi-pesquer", player_name: "Жорди Пескер", player_number: null, position: "DF" },
  { player_id: "player-ebrima-tunkara", player_name: "Эбрима Тункара", player_number: null, position: "MF" },
  { player_id: "player-orian-goren", player_name: "Ориан Горен", player_number: null, position: "MF" },
  { player_id: "player-brian-farinas", player_name: "Брайан Фариньяс", player_number: null, position: "MF" },
  ...
  { player_id: "player-hamza-abdelkarim", player_name: "Хамза Абделькарим", player_number: null, position: "FW" },
